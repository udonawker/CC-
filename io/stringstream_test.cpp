...
int main(int argc, char* argv[])
{
    ...
    std::stringstream ss(std::string("aaabbbccc"), std::stringstream::in | std::stringstream::out | std::stringstream::trunc);
    ...
    ::printf("size = %u\n", ss.str().size());
    ::printf("str = %u\n", ss.str().c_str());
    ::printf("tellg end0= %u eof(%d) fail(%d) bad(%d)\n", ss.tellg(), ss.eof(), ss.fail(), ss.bad());
